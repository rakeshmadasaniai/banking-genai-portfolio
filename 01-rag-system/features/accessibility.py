...
def apply_accessibility_styles(options: AccessibilityOptions) -> None:
    ...
    st.markdown(
        ...
        .composer-fixed div[data-testid="stForm"] {{
            background: #FFFFFF;
            border: 1px solid {border};
            border-radius: 14px;
            padding: 0.55rem 0.55rem 0.45rem;
        }}
        .composer-fixed div[data-testid="stPopover"] button,
        .composer-fixed div[data-testid="stSelectbox"] > div[data-baseweb="select"] > div,
        .composer-fixed div[data-testid="stTextInput"] input,
        .composer-fixed button[kind="secondary"],
        .composer-fixed button[kind="primary"] {{
        ...
        .composer-fixed button[kind="primary"]:hover {{
